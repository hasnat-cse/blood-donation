...
<?php 
	...
	<body style="background:url('images/back.png') ">
		...
		width:97%;float:left;">
	<h1 align="center"><b><font color="LightCyan">See Member Info</font></b></h1>
...
<fieldset>
	<legend>Personal Panel</legend>
		...
		<form action="see_members_admin.php" method="POST">
			...
			<ul>
				<li>
					...
					<select id="Hall" name="Hall">
						<?php
							$query= "select hall_name from hall_names where id='{$_SESSION["user_id"]}' ";
							$buff=mysql_query($query,$connection);
							confirm_query($buff);
		...
		<div id="subcontent" style="position:relative;overflow:auto;height:90%;width:58%;text-align:center;
				float:left;">
